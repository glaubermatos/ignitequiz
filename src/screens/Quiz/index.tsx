...
const CAR_SKIP_QUESTION_AREA = (-200)
...
export function Quiz() {
  ...
  const fixedProgressBarAnimatedStyles = useAnimatedStyle(() => {
    return {
      position: 'absolute',
      paddingTop: 50,
      zIndex: 1,
  ...
  .onEnd((event) => {
    if (event.translationX < CAR_SKIP_QUESTION_AREA) {
  ...
  const dragAnimatedStyles = useAnimatedStyle(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={fixedProgressBarAnimatedStyles}>
      ...
      >
        ...
        <GestureDetector gesture={onPan}>
          <Animated.View style={[shakeAnimatedStyle, dragAnimatedStyles]}>
            <Question
